...
true, then attack it. [INVARIANTS.md](INVARIANTS.md) lists one hundred and nineteen such
...
INVARIANTS.md           one hundred and nineteen statements that must hold, and the test for each
