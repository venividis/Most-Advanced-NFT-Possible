...
true, then attack it. [INVARIANTS.md](INVARIANTS.md) lists one hundred and fifteen such
...
INVARIANTS.md           one hundred and fifteen statements that must hold, and the test for each
